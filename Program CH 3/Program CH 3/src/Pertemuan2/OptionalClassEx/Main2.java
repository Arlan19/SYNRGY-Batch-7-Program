...
//        GET object
        ...
        Optional<String> categoryProduct = detailProduct1.flatMap(DetailProduct::getCategory).map(Category::getName);
        System.out.println("Velue dari kategory product " + categoryProduct);
...
//        map Object 2
        Optional<Optional<Category>> categoryProduct2 = detailProduct1.map(DetailProduct::getCategory);
        System.out.println("Value categoryProduct="+categoryProduct2);
...
// optionalLength akan berisi panjang dari string "Hello", yaitu 5

//        Optional<String> optionalString2 = Optional.of("Hello");
//        Optional<Integer> optionalLength2 = optionalString.flatMap(toString()::length);
// optionalLength akan berisi panjang dari string "Hello", yaitu 5
    }
}
