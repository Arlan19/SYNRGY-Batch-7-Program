...
class RestaurantController {
    ...
    private void completeOrder(Order order) {
        ...
        // Simpan struk pembayaran sebagai file .txt
        // Kode untuk menyimpan struk ke file .txt disini

        try (PrintWriter writer = new PrintWriter(new FileWriter("struk_EX2_pembayaran.txt"))) {
            writer.println("===================");
